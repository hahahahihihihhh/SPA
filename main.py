...
def main():
    ...
    parser.add_argument("--weight_decay", type=float, default=10 ** -3.6837809311904373) # 5e-4
    ...
    parser.add_argument("--search_max_epoch", type=int, default=200) # 800
    ...
    # spos config
    parser.add_argument("--arch_sample_num", type=int, default=200)  # 1000
    ...
    parser.add_argument("--weight_path", type=str, default='weights/SZ_TAXI_D/search/spos/SPASPOSSearch/20241220_151257_43/epoch_200.pt')  # ''
    ...
    parser.add_argument("--search_res_file", type=str, default="searched_res/SZ_TAXI_D/spos_search/20241221_010330.json")    # ''
