...
dim = "dim_128"
args_config = 'saved_models/SZ_TAXI_S/SPASPOSSearch_2_43_all.json'
...
def main():
    ...
    #     poi_emb = ent_embed[-156:]
    #     poi_emb = poi_emb(ent_embed)
    #     pd.DataFrame(poi_emb.detach().cpu().numpy()).to_csv('./emb/poi/{}.csv'.format(dim), header=False, index=False)
